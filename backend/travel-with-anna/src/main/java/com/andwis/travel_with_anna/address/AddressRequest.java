...
public class AddressRequest {
    @Size(max = 100, message = "Place name should be 100 characters or less")
    private String place;

    @Size(max = 100, message = "Country name should be 100 characters or less")
    private String country;

    @Size(max = 3, message = "Country code should be 3 characters or less")
    private String countryCode;

    @Size(max = 100, message = "City name should be 100 characters or less")
    private String city;
