...
class TripControllerTest {
    ...
    @Test
    @WithMockUser(username = "email@example.com", authorities = "User")
    void addViewer_ShouldReturnOk() throws Exception {
        // Given
        Long tripId = 1L;
        Long viewerId = 2L;
        ...
        mockMvc
                .perform(MockMvcRequestBuilders
                        .patch("/trip/{tripId}/viewer/{viewerId}/add", tripId, viewerId)
                        .principal(createAuthentication(user))
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    @Test
    @WithMockUser(username = "email@example.com", authorities = "User")
    void removeViewer_ShouldReturnOk() throws Exception {
        // Given
        Long tripId = 1L;
        Long viewerId = 2L;
        ...
        mockMvc
                .perform(MockMvcRequestBuilders
                        .patch("/trip/{tripId}/viewer/{viewerId}/remove", tripId, viewerId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
    ...
    @Test
    @WithMockUser(username = "email@example.com", authorities = "User")
    void getTripViewers_ShouldReturnOk() throws Exception {
        // Given
        Long tripId = 1L;
        ...
        mockMvc
                .perform(MockMvcRequestBuilders
                        .get("/trip/{tripId}/viewers", tripId)
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }
